...
apt-get -y install zlib1g-dev libssl-dev libreadline6-dev curl
apt-get -y install wget runit runit-services openssl libcurl4-openssl-dev libyaml-dev
...
# echo -e '#!/bin/bash\nexec svlogd -tt ./main\nEOF' > /etc/sv/chef-client/log/run

...
# default[:log_integration][:logrotate][:maxage]                 = nil
...
default[:log_integration][:logrotate][:olddir]                 = '/var/log/rotated'
...
# default[:log_integration][:logrotate][:size]                   = nil
...
# default[:log_integration][:logrotate][:start]                  = nil

...
default[:zabbix][:server][:log_dir]           = '/var/log/zabbix/zabbix_server'
...
default[:zabbix][:java_gateway][:log_dir] = '/var/log/zabbix/zabbix_java'
...
default[:zabbix][:agent][:log_dir]                = '/var/log/zabbix/zabbix_agent'
...
default[:zabbix][:web][:log_dir]        = '/var/log/zabbix/zabbix_web'

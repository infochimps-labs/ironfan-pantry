...
default[:zabbix][:server][:log_dir]           = nil  # set by volume_dirs 
...
default[:zabbix][:java_gateway][:log_dir] = nil # set by volume_dirs
...
default[:zabbix][:agent][:log_dir]                = nil # set by volume_dirs
...
default[:zabbix][:web][:log_dir]        = nil # set by volume_dirs 

...
default[:jenkins_integration][:ironfan_ci][:chef_user]          = 'testmonkey'  # FIXME
default[:jenkins_integration][:ironfan_ci][:cluster]            = 't9'          # FIXME
default[:jenkins_integration][:ironfan_ci][:facet]              = 'simple'      # FIXME

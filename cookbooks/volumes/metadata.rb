...
attribute "silverware/aws_credential_source",
  :display_name          => "",
  :description           => "where should we get the AWS keys?",
  :default               => "data_bag"

attribute "silverware/aws_credential_handle",
  :display_name          => "",

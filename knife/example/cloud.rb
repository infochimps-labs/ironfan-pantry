...
Chef::Config.instance_eval do
  ...
  # #     "#{knife_dir}/#{organization}/#{organization}-validator.pem"
  # #
  ...
  # #
  # cluster_path  [ "#{homebase}/clusters", "#{homebase}/vendor/infochimps_v2/clusters" ]
  ...
  #   "#{homebase}/vendor/infochimps-cookbooks/cookbooks",
  #   ]
